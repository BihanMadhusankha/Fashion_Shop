...
public class changeOrderStatus extends JFrame{
		...
		changeOrderStatus(CustomerList Orders){
			setSize(600,600);
        ...
        title = new JLabel("Change Order Status");
        ...
        buttonSearchOrder.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                ...
                Orders.searchChangeStatusorder(orderId, changeOrderStatus.this); 
            }
        });
        ...
        buttonChangeStatus = new JButton("Change Status");
        buttonChangeStatus.setFont(new Font("", Font.BOLD, 10));
        deleteButtonPanel.add(buttonChangeStatus);
        textViewFieldPanel.add(deleteButtonPanel);
        
         buttonChangeStatus.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
				String statusValue = txtStatus.getText();
				String orderId = txtEnterOrderId.getText();
				System.out.println(statusValue);
				if (statusValue.equals("Processing") || statusValue.equals("PROCESSING")){
					System.out.println(statusValue);
					Orders.changeStatus(orderId,1,changeOrderStatus.this);
				}
                else if (statusValue.equals("Delivering") || statusValue.equals("DELIVERING")){
					System.out.println(statusValue);
					Orders.changeStatus(orderId,2,changeOrderStatus.this);
				}
            }
        });
